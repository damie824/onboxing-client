...
export default function Footer() {
  ...
  return (
    <>
      <div
        className={
          !isMenuOpen ? "footer-more" : "footer-more footer-more-opened"
        }
        id="footer-menu"
      >
        <FooterButton
      ...
      <footer id="footer" className="global-footer">
        ...
        <a
          className={
            isMenuOpen
              ? "footer-plus-buttons footer-plus-buttons-close"
              : "footer-plus-buttons "
          }
          onClick={() => {
...
function FooterButton(props: {
  ...
  return (
    <a className={"footer-button"} href={props.url}>
      {props.icon}
      <p className="footer-button-texts">{props.title}</p>
    </a>
  );
}
